package com.efunds.market.mc.infrastructure.error;
...
public class ExtendedErrorAttributes implements ErrorAttributes, HandlerExceptionResolver,
        Ordered {

    private static final String ERROR_ATTRIBUTE = ExtendedErrorAttributes.class.getName()
            + ".ERROR";
    ...
    private void addErrorDetails(Map<String, Object> errorAttributes,
        ...
        if (error != null) {
            ...
            if(error instanceof LogicException){
                ...
                errorAttributes.put("message", "系统繁忙！");
            }
